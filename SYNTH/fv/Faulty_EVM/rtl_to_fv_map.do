...
# Generated on: Thu Nov 20 14:10:30 IST 2025 (Thu Nov 20 08:40:30 UTC 2025)
...
set_log_file fv/Faulty_EVM/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/Faulty_EVM -revised fv_map
...
set env(CDN_SYNTH_ROOT) "/cadence_tools/GENUS201/tools.lnx86"
set CDN_SYNTH_ROOT      "/cadence_tools/GENUS201/tools.lnx86"
set env(CW_DIR) "/cadence_tools/GENUS201/tools.lnx86/lib/chipware"
set CW_DIR      "/cadence_tools/GENUS201/tools.lnx86/lib/chipware"
...
read_library -liberty -both /home/pgstudent37/Faulty_EVM_1/SYNTH/../LIB/slow_vdd1v0_basicCells.lib
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  ../RTL/Faulty_EVM.v
elaborate_design -golden -root {Faulty_EVM} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/Faulty_EVM/fv_map.v.gz
elaborate_design -revised -root {Faulty_EVM}
...
#add_name_alias fv/Faulty_EVM/fv_map.singlebit.original_name.alias.json.gz -revised
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles fv/Faulty_EVM/rtl_to_fv_map.log
}
